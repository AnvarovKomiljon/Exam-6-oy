  ...
  return (
    <form onSubmit={handleSubmitTeacher} className='  h-[500px] p-2 rounded-md m-5'>
      ...
      <div className='flex justify-between'>
        <h2 className='mb-5 font-bold text-'>Add Teacher</h2>
      ...
      <div className='flex flex-wrap items-center justify-between  w-[990px]' >
        ...
        <label className='flex flex-col mb-3'>
          <span>Class</span>
          <input name='class' className="w-[407px] h-[40px] p-1.5 outline-none rounded-md  border-[1px] border-slate-300 " type="number" placeholder='Class' />
        </label>
        <label className='flex flex-col mb-3'>
          <span>Gender</span>
          <input name='gender' className="w-[407px] h-[40px] p-1.5 outline-none rounded-md  border-[1px] border-slate-300 " type="select" placeholder='Gender' />
        </label>
        <label className='flex flex-col mb-3'>
          <span>Subjact</span>

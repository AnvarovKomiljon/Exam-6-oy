...
function Navbar() {
  return (
    <nav className='flex flex-col w-[192px] mt-5 text-white font-semibold items-center justify-center '>
     ...
     <NavLink className="flex text-[14px] items-center justify-center gap-3 w-[192px] h-[44px] hover:bg-[#2C86D2] rounded-md" to={"/settingsandprofile"}> <img src={setting} alt="" /> SettingsAndProfile</NavLink>
